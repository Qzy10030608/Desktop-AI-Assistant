...
class AudioMessageWidget(QFrame):
    ...
    def __init__(self, text: str, parent=None, assistant_display_name: str | None = None):
        ...
        left_col.setSpacing(MAIN_WINDOW_SIZE["chat_message_spacing"])

        self.title_label = QLabel(self._assistant_title())
    ...
    def set_assistant_display_name(self, name: str):
        ...
        self.title_label.setText(self._assistant_title())
