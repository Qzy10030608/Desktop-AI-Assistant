...
class MainTopToolbar(QWidget):
    ...
    def retranslate_ui(self, t):
        self.title_label.setText(t("toolbar.title"))
        self.reply_btn.setToolTip(t("toolbar.reply_text"))
        self.status_btn.setToolTip(t("toolbar.system_status"))
        self.settings_btn.setToolTip(t("toolbar.settings"))
